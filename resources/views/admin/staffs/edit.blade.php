    ...
    <div class="col-10">
        <div class="card">
            <div class="card-body">
                ...
                <form id="staff_create_form" class="form-sample" method="POST" action="{{ route('staffs.update', $staff->id) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" class="form-control" name="date_of_join"  value="{{ $staff->date_of_join }}" />
