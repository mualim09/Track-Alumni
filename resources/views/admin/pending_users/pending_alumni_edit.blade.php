    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title">Pending Alumni</h4>
                
                    <form id="alumni_create_form" class="form-sample" method="POST" action="{{ route('admin.alumnies.pending_alumni_update', $alumni->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="name" class="form-control" value="{{ $alumni->name }}" readonly/>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" class="form-control" name="date_of_birth" value="{{ $alumni->date_of_birth }}"  readonly/>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="phone" class="form-control" value="{{ $alumni->phone }} " readonly/>
                    ...
                    <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" name="maritial_status" readonly>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="present_address" class="form-control" value="{{ $alumni->present_address }}" readonly/>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="permanent_address" class="form-control" value="{{ $alumni->permanent_address }}" readonly/>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form-check">
                                <input name="donate_blood" class="form-check-input" type="checkbox" value="1"  {{ $alumni->donate_blood ? 'checked' : '' }} id="donateBlood" readonly>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="student_id" class="form-control" value="{{ $alumni->student_id }}" readonly/>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="number" name="batch" class="form-control" value="{{ $alumni->batch }}" readonly/>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="cgpa" class="form-control" value="{{ $alumni->cgpa }}" readonly/>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="passing_year" class="form-control" value="{{ $alumni->passing_year }}" readonly/>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="profession" class="form-control" value="{{ $alumni->profession }}" readonly/>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="field" class="form-control" value="{{ $alumni->field }}" readonly/>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="organization" class="form-control" value="{{ $alumni->organization }}" readonly/>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="designation" class="form-control" value="{{ $alumni->designation }}" readonly/>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="office_email" class="form-control" value="{{ $alumni->office_email }}" readonly/>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="office_address" class="form-control" value="{{ $alumni->office_address }}" readonly/>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group col-xs-12">
                                <input type="file" name="image" class="form-control file-upload-info" placeholder="Upload Image" readonly>
                            </div>
