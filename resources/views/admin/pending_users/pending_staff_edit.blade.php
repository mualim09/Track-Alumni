        ...
        <div class="card">
            <div class="card-body">
                <div class="alert alert-success" id="success-alert" style="display:none; text-align:center;">
                    ...
                    <strong style="text-align:center">Updated Successfully!</strong>
                </div>
                <h4 class="card-title">Pending Staff</h4>
                <form id="staff_create_form" class="form-sample" method="POST" action="{{ route('admin.staffs.pending_staff_update', $staff->id) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="qualification" class="form-control" value="{{ $staff->qualification }}" readonly/>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="designation" class="form-control"  value="{{ $staff->designation }}" readonly/>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="date" class="form-control" name="date_of_join"  value="{{ $staff->date_of_join }}"  readonly/>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="phone" class="form-control"  value="{{ $staff->phone }}" readonly/>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="address" class="form-control"  value="{{ $staff->address }}" readonly/>
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="email" name="email" class="form-control"  value="{{ $staff->email }}" readonly/>
