...
@section('content')
            ...
            <div class="col-12">
				<img src="{{ asset('assets/images/alumni-banner.jpg')}}" class="img-fluid w-100 mb-4 rounded-lg" alt="author">
				<div class="content">
					<p>Alumni today are the best source of jobs, donation & knowledge capital for you institute, so get them back by signing up for ALUMNI today!
