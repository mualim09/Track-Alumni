        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="department" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded"> 
                        <a class="collapse-item" href="{{ route('departments.index') }}">Department List</a>
                        <a class="collapse-item" href="{{ route('departments.create') }}">Create Department</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="training" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded"> 
                        <a class="collapse-item" href="{{ route('trainings.index') }}">Training List</a>
                        <a class="collapse-item" href="{{ route('trainings.create') }}">Schedule Training</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="fund" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded"> 
                        <a class="collapse-item" href="{{ route('funds.index') }}">View Collection</a>
                        <a class="collapse-item" href="{{ route('funds.create') }}">Update Investment</a>
                        <a class="collapse-item" href="{{ route('funds.index') }}">View Investment</a>
                    </div>
                </div>
            </li>
        ...
        <li class="nav-item">
                ...
                <div id="gallery" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded"> 
                        ...
                        <a class="collapse-item" href="{{ route('galleries.create') }}">Create Gallery</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"> {{ Auth::staff()->name }} </span>
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Developed by Raiyan Najia and Arni Sultana</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
